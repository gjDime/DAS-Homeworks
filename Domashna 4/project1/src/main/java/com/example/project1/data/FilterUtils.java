...
public class FilterUtils {
    ...
    public FilterUtils(BusinessRepository businessRepository, PriceLogRepository priceLogRepository) {
        this.businessRepository = businessRepository;
        this.priceLogRepository = priceLogRepository;
    }

    public void addHistoricalData(BusinessEntity company, LocalDate fromDate, LocalDate toDate) throws IOException {
